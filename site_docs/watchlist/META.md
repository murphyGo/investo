...
- [yfinance-price] **ticker**: META 751.66 (-3.33%)
...
- [yfinance-price] **ticker**: META 744.10 (+1.02%)
...
- [yfinance-price] **ticker**: META 736.60 (-0.63%)
- [yonhap-market] **ticker**: "메타, AI 비서 통화에 '인간 대역' 투입 시험"
...
- [yfinance-price] **ticker**: META 665.75 (-2.43%)
- [yonhap-market] **ticker**: 메타, 영국 온라인안전법에 소송…"법시행 지연 목적"
...
- [yfinance-price] **ticker**: META 673.31 (+0.46%)
...
- [yfinance-price] **ticker**: META 665.60 (+2.71%)
...
- [yfinance-price] **ticker**: META 648.03 (+0.57%)
...
- [yfinance-price] **ticker**: META 644.38 (-1.42%)
...
- [yfinance-price] **ticker**: META 653.69 (+6.55%)
...
- [yfinance-price] **ticker**: META 613.48 (-0.53%)
...
- [yfinance-price] **ticker**: META 610.68 (+3.01%)
...
- [yfinance-price] **ticker**: META 590.24 (+6.02%)
...
- [yfinance-price] **ticker**: META 572.34 (-0.98%)
...
- [yfinance-price] **ticker**: META 570.05 (+1.97%)
...
- [yfinance-price] **ticker**: META 549.90 (+0.75%)
...
- [yfinance-price] **ticker**: META 545.83 (-0.04%)
- [yonhap-market] **ticker**: "저커버그, 아동안전보다 회사성장 우선 조장했다"
...
- [yfinance-price] **ticker**: META 546.03 (+0.43%)
...
- [yfinance-price] **ticker**: META 543.67 (-4.45%)
- [yonhap-market] **ticker**: 메타 상대 美 29개주 '청소년 중독 소송' 개시
...
- [yfinance-price] **ticker**: META 568.97 (-3.54%)
...
- [yfinance-price] **ticker**: META 589.85 (-0.86%)
...
- [yfinance-price] **ticker**: META 594.97 (+2.78%)
- [yonhap-market] **ticker**: 메타, 호주 16세 미만 SNS 계정 75만여개 삭제
...
- [yfinance-price] **ticker**: META 578.85 (-3.38%)
...
- [yfinance-price] **ticker**: META 599.12 (+0.71%)
...
- [yfinance-price] **ticker**: META 594.92 (+0.48%)
...
- [yfinance-price] **ticker**: META 592.10 (+0.37%)
...
- [yfinance-price] **ticker**: META 589.90 (+0.19%)
...
- [yfinance-price] **ticker**: META 588.77 (+0.14%)
...
- [yfinance-price] **ticker**: META 587.94 (-0.39%)
...
- [yfinance-price] **ticker**: META 556.71 (+3.28%)
...
- [nasdaq-symbol-directory] **ticker**: META listing metadata: Meta Platforms, Inc. - Class A Common Stock
- [sec-company-facts] **ticker**: META SEC company facts: Meta Platforms, Inc.
- [yfinance-price] **ticker**: META 593.41 (-0.08%)
...
- [nasdaq-symbol-directory] **ticker**: META listing metadata: Meta Platforms, Inc. - Class A Common Stock
- [sec-company-facts] **ticker**: META SEC company facts: Meta Platforms, Inc.
- [yfinance-price] **ticker**: META 593.87 (-2.02%)
...
- [nasdaq-symbol-directory] **ticker**: META listing metadata: Meta Platforms, Inc. - Class A Common Stock
- [sec-company-facts] **ticker**: META SEC company facts: Meta Platforms, Inc.
- [yfinance-price] **ticker**: META 595.19 (-1.80%)
...
- [nasdaq-symbol-directory] **ticker**: META listing metadata: Meta Platforms, Inc. - Class A Common Stock
- [sec-company-facts] **ticker**: META SEC company facts: Meta Platforms, Inc.
- [yahoo-finance-news] **ticker**: Mark Zuckerberg's Meta Is Putting Its In-House Iris AI Chip Into Production in September as Part of a Plan to Double…
...
- [yonhap-market] **ticker**: 메타, 캐나다에 13조원 데이터센터 구축 계획
...
- [yonhap-market] **ticker**: 이번엔 메타…다시 불거진 반도체 수요위축 우려에 코스피 출렁
- [nasdaq-symbol-directory] **ticker**: META listing metadata: Meta Platforms, Inc. - Class A Common Stock
- [sec-company-facts] **ticker**: META SEC company facts: Meta Platforms, Inc.
- [yfinance-price] **ticker**: META 582.90 (-4.90%)
...
- [stooq-price] **ticker**: META 627.57
- [theblock-crypto] **ticker**: Coinbase, SpaceX, Meta join DOJ anti-scam operation that froze $3.8 million in crypto
...
- [stooq-price] **ticker**: META 623.01
...
- [yonhap-market] **ticker**: 삼성전자, 장중 메타 제치고 글로벌 시가총액 10위로
- [yonhap-market] **ticker**: 삼전, 메타 제치고 글로벌 시총 10위…한때 테슬라 추월도(종합)
- [stooq-price] **ticker**: META 597.64
...
- [stooq-price] **ticker**: META 600.37
...
- [stooq-price] **ticker**: META 632.51
...
- [stooq-price] **ticker**: META 635.29
...
- [stooq-price] **ticker**: META 612.34
...
- [stooq-price] **ticker**: META 610.26
...
- [stooq-price] **ticker**: META 607.38
...
- [stooq-price] **ticker**: META 604.87
...
- [stooq-price] **ticker**: META 602.75
...
- [stooq-price] **ticker**: META 611.50
...
- [stooq-price] **ticker**: META 614.23
...
- [stooq-price] **ticker**: META 616.54
...
- [stooq-price] **ticker**: META 598.86
...
- [stooq-price] **ticker**: META 609.63
- [theblock-crypto] **ticker**: Senator Warren presses Meta over stablecoin trial ahead of 2026 rollout plans
