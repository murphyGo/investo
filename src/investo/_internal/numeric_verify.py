"""u55 Step 2 — Shared core market-fact verification gate.
...
``NormalizedItem``). The briefing compatibility module and the publisher
terminal finalizer both consume this neutral owner.
"""
