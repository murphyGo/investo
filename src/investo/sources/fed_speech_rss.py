"""Federal Reserve speech/testimony RSS adapter."""
...
@register
class FedSpeechRssAdapter:
    """Adapter for official Federal Reserve speeches and testimony RSS feeds."""

    name: ClassVar[str] = "fed-speech-rss"
    ...
    def _normalize_entry(self, entry: Any, *, feed_type: str) -> NormalizedItem | None:
        ...
        raw_metadata: dict[str, str] = {"feed_type": feed_type, "official_source": "true"}
