...
| sources | 무료 API들 (구현됨 2026-04-29: FOMC RSS — calendar; 구현됨 2026-05-01 extension #1: Yahoo Finance v8 chart — price/주가, CoinGecko Public API — price/crypto, FRED API — macro; 구현됨 2026-05-01 extension #2: Yahoo Finance top stories RSS — news, SEC EDGAR 8-K Atom — news; 진행 중 2026-05-01 extension #3 (general news 다양화): Yonhap 마켓+ RSS (`https://www.yna.co.kr/rss/market.xml`, 한국어) — news, The Block RSS (`https://www.theblock.co/rss.xml`, 크립토 narrative) — news, CNBC US Top News RSS (`https://www.cnbc.com/id/100003114/device/rss/rss.html`, 매크로/정책) — news; 향후 TBD: Earnings Calendar) | 데이터 수집 | FRED는 무료 API key 필수 (`FRED_API_KEY` GitHub Secret); SEC EDGAR은 fair-access User-Agent 필수 (compliance string, not a secret); 나머지(FOMC RSS / yfinance / CoinGecko / Yahoo Finance news RSS / Yonhap RSS / The Block RSS / CNBC RSS)는 키·헤더 모두 불필요 |
