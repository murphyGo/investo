...
- [x] Step 3 — Swap the 주의할 점 snippet bounding in `src/investo/publisher/reader_format/reflow.py` to the helper; apply Fixed Contract 3 for `_SNIPPET_CONTINUATION`; fallback per Fixed Contract 2.
