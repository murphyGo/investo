...
**Status**: Backlog — Functional Design ready; u150/u153 code dependencies integrated (2026-09-08)
...
- u150 terminal Markdown link containment — complete/integrated on main.
- u153 summary sentence boundary — complete/integrated (2026-09-08); consume
  its existing final-summary contract. This does not approve u154 design/code.
