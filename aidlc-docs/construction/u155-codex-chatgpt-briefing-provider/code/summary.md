...
the user authorized committing and pushing this feature branch. Integration with refreshed main `fc373277` is included in the follow-up
integration change; see `docs/sessions/2026-09-09-u155-main-integration.md`.
Private operational activation remains separate.
