...
| Code Generation | ✅ Complete (all 6 units) — ✅ u1 extension closed 2026-05-01 (3 new adapters: yfinance/CoinGecko/FRED); ✅ u1 extension #2 closed 2026-05-01 (2 news adapters: yahoo-finance-news + sec-edgar-8k; Category 3/5 → 4/5; +35 tests) | 2026-05-01 |
| Build and Test | ✅ Complete — re-verified after u1 extension (775/775 tests, mypy --strict 41 src files, mkdocs --strict); re-verified after u1 extension #2 (810/810 tests, mypy --strict 43 src files) | 2026-05-01 |
...
| u1 sources | ✅ Complete | ✅ Complete (+AC-3.6/AC-5.5 in extension) | ✅ Complete (10/10 base + 5/5 extension + 4/4 extension #2) — ✅ Extension #2 closed 2026-05-01 (2 news adapters: yahoo-finance-news + sec-edgar-8k); 4/5 Category enum values covered (earnings still TBD) | 252 base tests + 55 ext-#1 tests + **35 ext-#2 tests (14 yahoo + 21 sec-edgar)** = **342 u1 tests**; **14 source files (8 base + 4 ext-#1 + 2 ext-#2)**; 32 NFR ACs unchanged (no new ACs in ext-#2); US-001 now covers calendar/price/macro/news (4/5 — only earnings deferred); US-008 plugin re-validated again under 6-adapter contract; ext-#1 cross-cutting sub-agent review APPROVE_WITH_NOTES (H1+L3+M2 fixed; M1 → DEBT-028 Medium); ext-#2 Phase 3 qa APPROVE_WITH_NOTES (0 Critical / 0 High; M1+M2 → DEBT-029+DEBT-030 Low); 5 FD divergences ratified across both extensions (L6.2 R7 relaxation, L6.4 35d→65d, L6.4 title precision, **L6.5 pubDate parser: `datetime.fromisoformat` not `parsedate_to_datetime` — 3.11 doesn't accept ISO 8601 in the latter** [FD prose corrected at ext-#2 closeout], **`SecEdgar8kAdapter` lowercase k per PEP 8**); R14 added 2026-05-01 (SEC fair-access UA). Plans: `aidlc-docs/construction/plans/u1-sources-extension-2026-05-code-generation-plan.md` ✅ + `u1-sources-extension-2026-05-news-code-generation-plan.md` ✅ |
