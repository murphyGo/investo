...
| u3 publisher | ⏭️ SKIP | ⏭️ SKIP | ⏳ in progress (CG plan approved 2026-04-30, 9 steps; Step 1 next) | FD + NFR both SKIP per execution-plan; consumes Briefing + DISCLAIMER from u2 (already shipped); zero new deps |
