...
| u23 notification actionability | ⏭️ SKIP initially (notifier UX correction) | ⏭️ SKIP initially (no new external deps) | ⏳ Planned | Second reader/operator review follow-up: make segmented alerts more actionable with status/link blocks and operator-visible partial notify failures. Requested first implementation unit. |
