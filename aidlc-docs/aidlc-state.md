...
| Build and Test | ✅ Complete — re-verified after u19 briefing visual assets follow-up on 2026-05-07: ruff ✅, ruff format ✅ (154 files), mypy --strict ✅ (59 source files), pytest ✅ 1011/1011, mkdocs build --strict ✅. u20-u24 quality follow-up units added 2026-05-07; requested implementation order: u23 -> u21 -> u20. | 2026-05-07 |
...
| u22 source coverage transparency | ⏭️ SKIP initially (trust/diagnostics extension) | ⏭️ SKIP initially (no new external deps) | ⏳ Planned | Second reader/operator review follow-up: expose source-level coverage reasons and reader-facing collection status. |
...
| u24 visual provenance and layout | ⏭️ SKIP initially (visual trust/layout extension) | ⏭️ SKIP initially (no new external deps) | ⏳ Planned | Second reader/operator review follow-up: store visual provenance, render captions, and reduce first-viewport visual crowding. |
