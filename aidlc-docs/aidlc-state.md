...
| u20 archive trust and latest index | ⏭️ SKIP initially (site discovery/trust correction) | ⏭️ SKIP initially (no new external deps) | ⏳ Planned | Second reader/operator review follow-up: automate latest segmented archive discovery and separate or label legacy single-briefing pages. Requested implementation after u23 and u21. |
