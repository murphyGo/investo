...
| u21 summary quality gate | ⏭️ SKIP initially (publish-time UX guard) | ⏭️ SKIP initially (no new external deps) | ⏳ Planned | Second reader/operator review follow-up: prevent broken first-viewport summary lines from reaching public archive pages. Requested implementation after u23. |
