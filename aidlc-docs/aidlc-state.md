...
| u1 sources | ✅ Complete | ✅ Complete (+AC-3.6/AC-5.5 in extension) | ✅ Complete (10/10 base + 5/5 extension + 4/4 extension #2 + 4/4 extension #3) — ✅ Extension #3 closed 2026-05-01 (3 general news: yonhap-market + theblock-crypto + cnbc-top-news); news adapter count specifically now **5**; **9 adapters total**; 4/5 Category enum values covered (earnings still TBD) | 252 base tests + 55 ext-#1 tests + 35 ext-#2 tests + **54 ext-#3 tests (16 yonhap + 23 theblock + 15 cnbc)** = **396 u1 tests**; **17 source files (8 base + 4 ext-#1 + 2 ext-#2 + 3 ext-#3)**; 32 NFR ACs unchanged (no new ACs in ext-#3); +ext-#3 (3 general news: yonhap-market + theblock-crypto + cnbc-top-news); US-001 covers calendar/price/macro/news (4/5 — only earnings deferred; ext-#3 grows news depth, not breadth); US-008 plugin re-validated again under 9-adapter contract; ext-#1 cross-cutting sub-agent review APPROVE_WITH_NOTES (H1+L3+M2 fixed; M1 → DEBT-028 Medium); ext-#2 Phase 3 qa APPROVE_WITH_NOTES (0 Critical / 0 High; M1+M2 → DEBT-029+DEBT-030 Low); ext-#3 Phase 4 qa APPROVE_WITH_NOTES (0 Critical / 0 High / 4 Medium / 4 Low; M1 FD §L6.8 drift fixed inline; M2/M3/M4/L1 → DEBT-031/032/033/034 — 4 new: 2 Medium, 2 Low); 6 FD divergences ratified across all three extensions (L6.2 R7 relaxation, L6.4 35d→65d, L6.4 title precision, **L6.5 pubDate parser: `datetime.fromisoformat` not `parsedate_to_datetime` — 3.11 doesn't accept ISO 8601 in the latter** [FD prose corrected at ext-#2 closeout], **`SecEdgar8kAdapter` lowercase k per PEP 8**, **L6.8 utm-strip 2→5 keys + raw_metadata key names `creator`/`categories` + omit-when-absent** [FD prose corrected at ext-#3 closeout]); R14 added 2026-05-01 (SEC fair-access UA). Plans: `aidlc-docs/construction/plans/u1-sources-extension-2026-05-code-generation-plan.md` ✅ + `u1-sources-extension-2026-05-news-code-generation-plan.md` ✅ + `u1-sources-extension-2026-05-news-2-code-generation-plan.md` ✅ |
