...
| u6 infra/CI | N/A | N/A | ⏳ in progress (Step 1 of 7 — bootstrap) | FD/NFR both N/A; CG plan APPROVED; Step 1 ✅ (.github/workflows + site_docs dirs + pyproject docs extra w/ mkdocs-material>=9.5 + landing-page placeholders); 37 src files unchanged; 705/705 tests; Step 2 (daily-briefing.yml) next |
