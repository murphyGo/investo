...
| Code Generation | 🚧 Reopened — original 6 units complete; u7 segmented briefing closed 2026-05-07; u8 source-window correction closed 2026-05-07; u9 reader-experience slice closed 2026-05-07; u10 source diagnostics slice closed 2026-05-07; u11 HTTP identity-encoding slice closed 2026-05-07; u12 Claude stdin-prompt slice closed 2026-05-07; u13 LLM input candidate cap slice closed 2026-05-07; five-reader quality review generated u14-u18 follow-up units on 2026-05-07 | 2026-05-07 |
| Build and Test | ⏸️ Complete through u13 — re-verified after u13 LLM input candidate cap follow-up on 2026-05-07: ruff ✅, ruff format ✅ (140 files), mypy --strict ✅ (52 source files), pytest ✅ 977/977, mkdocs build --strict ✅. Re-run after u14-u18 implementation. | 2026-05-07 |
...
| u14 summary quality contract | ⏭️ SKIP (u2/u9 UX correction) | ⏭️ SKIP (no new external deps) | 📝 Planned | Five-reader quality review P0: stabilize the top `오늘의 결론 / 핵심 동인 / 주의할 점` block so markdown fragments and list markers cannot leak into the first viewport. Plan: `aidlc-docs/construction/plans/u14-summary-quality-contract-code-generation-plan.md`. |
| u15 coverage confidence badges | ⏭️ SKIP (u1/u2/u7 quality correction) | ⏭️ SKIP (observability/UX correction; no new external deps) | 📝 Planned | Five-reader quality review P0: expose per-segment coverage status and missing source categories so readers can distinguish normal, partial, and insufficient briefings. Plan: `aidlc-docs/construction/plans/u15-coverage-confidence-badges-code-generation-plan.md`. |
| u16 public site discovery | ⏭️ SKIP (site content/navigation correction) | ⏭️ SKIP (no new external deps) | 📝 Planned | Five-reader quality review P1: sync Home/About/Archive with segmented output and make latest domestic/us/crypto briefings discoverable without relying on sidebar navigation. Plan: `aidlc-docs/construction/plans/u16-public-site-discovery-code-generation-plan.md`. |
| u17 operations visibility | ⏭️ SKIP (runtime operations correction) | ⏭️ SKIP (no new external deps) | 📝 Planned | Five-reader/operator review P1: surface partial-success failures and run diagnostics through operator-facing summaries or alerts. Plan: `aidlc-docs/construction/plans/u17-operations-visibility-code-generation-plan.md`. |
| u18 watchlist relevance | ⏭️ SKIP (product relevance extension) | ⏭️ SKIP initially (no paid data, no accounts, no trading) | 📝 Planned | Five-reader/product review P2: add a lightweight non-secret watchlist layer for watched tickers/assets/sectors/keywords. Plan: `aidlc-docs/construction/plans/u18-watchlist-relevance-code-generation-plan.md`. |
