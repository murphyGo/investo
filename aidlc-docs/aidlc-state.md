...
| u2 briefing | ✅ Complete | ✅ Complete | ⏳ pending | FD + NFR approved 2026-04-28; NFR Reqs: 49 ACs (44 NFR + 5 drift) across NFR-001/002/003/004/005/006/007 + drift; tech stack = stdlib only (zero new deps); prompt templating via `briefing/prompts.py` constants + `str.format` |
