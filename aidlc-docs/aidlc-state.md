...
| u4 notifier | ⏭️ SKIP | ⏭️ SKIP | ⏳ in progress (Step 1 of 8 — bootstrap) | FD + NFR both SKIP per execution-plan; Step 1 ✅ (notifier pkg + tests dir); 29 src files; 500/500 tests; Step 2 (_telegram.py) next. Critical rules: CLAUDE.md #5 chat_id separation; NFR-007 bot-token redaction; FR-004/007 4096 UTF-16 cap |
