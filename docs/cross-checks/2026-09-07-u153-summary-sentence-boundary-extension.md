...
**Subsequent integration**: This report records the September 7 pre-u150
baseline. The September 8 combined-main integration passed 4,950 tests and
retains u150's now-integrated repair/replacement policy. See
`docs/sessions/2026-09-08-u153-main-integration.md`; production verification
remains separate. Historical gate counts and line references below are unchanged.
