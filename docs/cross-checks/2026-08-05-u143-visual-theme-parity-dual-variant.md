...
| NFR-005 — maintainability | ✅ | `src/investo/visuals/render.py:40-81`; `src/investo/visuals/paths.py:15-16`; `docs/DESIGN.md` TD-013 | One palette factory, one fragment home, registry-driven card coverage, no duplicated dark manifest policy. |
